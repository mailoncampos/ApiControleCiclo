...
import com.ApiOnlineSecurity.service.negocio.cicloEtapa.strategy.criacao.CriarCicloEtapaExtemporaneo;

@Component("CicloEtapaExtemporaneo")
public class CicloEtapaExtemporaneo implements CicloEtapaFactory{
	...
	public CicloEtapa criarCicloEtapa(CicloEtapaImpl cicloEtapaStrategy, ApplicationContext applicationContext) {
		CicloEtapa cicloEtapaSalvo = cicloEtapaStrategy.criaCicloEtapa(new CriarCicloEtapaExtemporaneo(applicationContext));
